...
void timeclassList(__int64*timet, int N) {
    ...
    auto time1 = std::chrono::duration_cast<std::chrono::microseconds>(finish1 - start1);
    timet[0] = time1.count();
    auto start2 = std::chrono::high_resolution_clock::now();
    sizeOfSet(setA);
    auto finish2 = std::chrono::high_resolution_clock::now();
    auto time2 = std::chrono::duration_cast<std::chrono::microseconds>(finish2 - start2);
    timet[1] = time2.count();
    auto start3 = std::chrono::high_resolution_clock::now();
    isSubsetAB(setA, setA);
    auto finish3 = std::chrono::high_resolution_clock::now();
    auto time3 = std::chrono::duration_cast<std::chrono::microseconds>(finish3 - start3);
    timet[2] = time3.count();
    auto start4 = std::chrono::high_resolution_clock::now();
    isSubsetAB(setA, setB);
    auto finish4 = std::chrono::high_resolution_clock::now();
    auto time4 = std::chrono::duration_cast<std::chrono::microseconds>(finish4 - start4);
    timet[3] = time4.count();
    auto start5 = std::chrono::high_resolution_clock::now();
    isEquallyAB(setA, setA);
    auto finish5 = std::chrono::high_resolution_clock::now();
    auto time5 = std::chrono::duration_cast<std::chrono::microseconds>(finish5 - start5);
    timet[4] = time5.count();
    auto start6 = std::chrono::high_resolution_clock::now();
    isEquallyAB(setA, setB);
    auto finish6 = std::chrono::high_resolution_clock::now();
    auto time6 = std::chrono::duration_cast<std::chrono::microseconds>(finish6 - start6);
    timet[5] = time6.count();
    auto start7 = std::chrono::high_resolution_clock::now();
    consolidationAB(setA, setB);
    auto finish7 = std::chrono::high_resolution_clock::now();
    auto time7 = std::chrono::duration_cast<std::chrono::microseconds>(finish7 - start7);
    timet[6] = time7.count();
    auto start8 = std::chrono::high_resolution_clock::now();
    intersectionAB(setA, setB);
    auto finish8 = std::chrono::high_resolution_clock::now();
    auto time8 = std::chrono::duration_cast<std::chrono::microseconds>(finish8 - start8);
    timet[7] = time8.count();
    auto start9 = std::chrono::high_resolution_clock::now();
    differenceAB(setA, setB);
    auto finish9 = std::chrono::high_resolution_clock::now();
    auto time9 = std::chrono::duration_cast<std::chrono::microseconds>(finish9 - start9);
    timet[8] = time9.count();
    ...
    auto time10 = std::chrono::duration_cast<std::chrono::microseconds>(finish10 - start10);
